...
Source code and data files (repository root): MIT License — see
[LICENSE](LICENSE). Manuscript and figures (`paper/`): Creative Commons
Attribution 4.0 (CC BY 4.0) — see [paper/LICENSE](paper/LICENSE).
